...
export type PluginInventoryStatus = 'bundled' | 'cache-detected' | 'protected' | 'invalid';

export type PluginComponentKind = 'skill' | 'app' | 'mcp-server';
...
export interface PluginComponentProvenance {
  pluginId: string;
  marketplace: string;
  pluginName: string;
  version: string;
...
export interface PluginInventoryVersion {
  id: string;
  version: string;
  author: string;
  description: string;
...
export interface PluginInventoryManagement {
  uninstall: 'unavailable';
}

export interface PluginInventoryPlugin {
  id: string;
  marketplace: string;
  name: string;
  displayName: string;
...
export interface PluginInventoryInvalidEntry {
  id: string;
  marketplace: string;
  name: string;
  version: string;
